...
**Categories:** AI, Developer Productivity, LLMs, Engineering
...
![A Slack message invoking a minion run](https://stripe.dev/images/minions-how-stripe-ships-code-end-to-end-with-llms-part-1/image1.png)
...
![A flaky test ticket with a button to start a minion that'd fix it](https://stripe.dev/images/minions-how-stripe-ships-code-end-to-end-with-llms-part-1/image2.png)

While the minion works, or after the fact, engineers can see the decisions and actions the minion took in a web UI.

![An example of the web interface for managing minion runs](https://stripe.dev/images/minions-how-stripe-ships-code-end-to-end-with-llms-part-1/image3.png)
...
Engineers can also iterate on a completed minion run manually once it's completed. While the North Star is a pull request produced without any human code, a minion run that's not entirely correct is often still an excellent starting point for an engineer's focused work.
