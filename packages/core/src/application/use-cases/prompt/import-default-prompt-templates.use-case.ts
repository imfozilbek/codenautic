...
/**
 * Dependencies for importing default prompt templates.
 */
export interface IImportDefaultPromptTemplatesUseCaseDependencies {
    /**
...
/**
 * Imports default prompt templates from settings-service payload.
 */
export class ImportDefaultPromptTemplatesUseCase
    implements IUseCase<readonly IConfigPromptTemplateItem[], IImportResult, ValidationError>
{
     ...
     */
    public constructor(dependencies: IImportDefaultPromptTemplatesUseCaseDependencies) {
