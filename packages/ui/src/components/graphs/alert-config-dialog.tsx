...
export function AlertConfigDialog(props: IAlertConfigDialogProps): ReactElement {
    ...
    return (
        <section className="rounded-lg border border-border bg-surface p-3 shadow-sm">
            <p className={TYPOGRAPHY.cardTitle}>{t("code-city:alertConfigComp.title")}</p>
            ...
            <button
                ...
                className="mt-3 rounded border border-accent/40 bg-accent/10 px-3 py-1 text-xs font-semibold text-accent-foreground"
                onClick={handleSave}
                type="button"
            >
